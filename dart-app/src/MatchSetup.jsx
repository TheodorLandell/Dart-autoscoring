...
/* ============ DARTBOARD SVG — för Throw for Bull ============ */
function Dartboard({ darts, onClickBoard, currentPlayerIndex, players }) {
...
/* ============ THROW FOR BULL VIEW ============ */
function ThrowForBull({ players, onComplete, onBack }) {
  ...
  /* Sortera spelare efter avstånd till bull (närmast först) */
